...
os.chdir('/home/xulingyun/codebase/ROS/catkin_ws/src/multinet/')
...
def main(_):
    ...
    '''
    resource = '/home/xulingyun/kitti.mp4'
    ...
    for i in f:
        ...
        image = scp.misc.imread(img_root+'/'+i.split('\n')[0])
